...
compose_command=(sudo podman run --rm --user "$(id -u):$(id -g)" -it -v $HOME/client.conf:/etc/openqa/client.conf:ro,z ghcr.io/ricardobranco777/openqa-cli /usr/share/openqa/script/clone_job.pl)
